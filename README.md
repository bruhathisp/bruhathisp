...
1. **Amazon, Bangalore**
   - *Jan 2025 - Present*
   - **Distributed Systems & Big Data Processing**: Owned end-to-end data pipeline development for financial systems, from architecture design to production deployment. Architected and implemented **push-based ETL pipelines** using **Apache Spark** with performance optimizations for large-scale transportation finance data.
   - **Data Orchestration & Processing**: Engineered complex data workflows using **Apache Airflow** and state machines to orchestrate multi-layered processing. Built and maintained services using **Guice** with layered abstraction for production systems.
   - **Full-Cycle Delivery**: Delivered data through Cradle pipelines with full historical backfilling and exposed datasets via **Athena** for downstream consumption. Improved cost allocation accuracy by identifying coverage gaps and implementing cross-region solutions.
